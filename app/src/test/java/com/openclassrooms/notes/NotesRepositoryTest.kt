...
class NotesRepositoryTest {
    ...
    fun setUp() {
        ...
        notesRepository = NotesRepository(notesApiService = localNotesApiService)
    }

    @Test
    fun getNotes_returnsExpectedNotes() = runTest {
        ...
        val actualNotes = notesRepository.notes.first()
